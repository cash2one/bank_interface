...
#define TC_OPERLOGIN		1110 	//登录系统
#define TC_OPERLOGOUT		1111 	//退出系统
...
#define TCM_BANKTMP			1330	//银行卡名单
#define TC_BANKBIND			1340	//银行卡联机绑定
#define TCM_OPERAUTH		1350	//操作员权限
#define TCM_DEPOSITOPERAUTH 1360    //充值操作员授权
#define TCM_WATERRATE		1370	//水费设置
#define TCM_DOORGROUP		1400   	//门禁组
#define TCM_PSAM 			1500	//PSAM卡
#define TCM_WATERFEE		1510	//水控费率
...
#define TC_CARDDISABLEREV	2121 //卡片作废取消
...
#define TC_SHOPCARDOPEN		2300 //商户卡发行
#define TC_SHOPCARDCLOSE	2310 //商户卡回收
#define TC_SHOPCARDLOSS		2320 //商户卡挂失
#define TC_SHOPCARDUNLOSS	2330 //商户卡解挂
...
#define TC_CARDUPDBASEINFO	3080  //更新卡信息
#define TC_CARDUPDEXPIREDATE 3081  //修改卡有效期
#define TC_CARDUPDBADCARD	3082 //坏卡修复
#define TC_CARDREWRITE		3083 //重写卡信息
#define TC_CARDUPDMAXAMT	3085  //修改消费限额

//#define TC_CARDSAVEINFO		3090 //换卡保存卡信息
#define TC_CARDINSTEADAPPLY	3090 //换卡申请
#define TC_CARDINSTEAD		3091 //换卡
#define TC_INSTEADADDBAL	3092 //换卡加卡余额
#define TC_NEWCARDCHANGE	3093 //新生换卡

#define TC_CARDDEPOSIT  	3100  //卡充值
#define TC_CARDDEPOSITREV 	3101 //卡充值冲正
#define TC_CARDAUTODEPOSIT  3102  //自助现金充值
...
#define TC_SUBSIDYCHECK		3125  //补助审核
...
#define TC_POSDRAWREV  		3161  //消费冲正
#define TC_POSDRAWCANCEL	3162  //消费取消
#define TC_BANKTRANS		3170  //圈存转账
#define TC_BANKSUBSIDY		3171	//网银下发补助
#define TC_BANKTRANSADD		3175	//圈存补帐
#define TC_CARDPAYMENT		3180  //卡支付交易
//#define TC_DEDUCTPUT 		3190  //下发扣款
...
#define TC_CARDBALUPD		3241  //卡余额修正
#define TC_WATERCARDBALMOD	3250  //水控卡余额调整
#define TC_WATERTRANS 		3260  //水控转账
#define TC_WATERJD2XT		3261  //竟达转新天水控
#define TC_WATERXT2JD		3262  //新天转竟达水控
#define TC_WATERPAY			3263  //后付费补扣
#define TC_WATERPAYUNLOCK	3264  //后付费解锁
#define TC_CARD2CARD		3270	//卡卡转账
#define TC_POSLOCKCARD		3280	//POS锁卡
#define TC_CONSUMEFAIL		3290	//消费失败
#define TC_SYSREV  			3300  	//系统冲正
#define TC_WATERDEPOSIT		3310	//水控充值
#define TC_WATERBALRETURN 	3320 	//退水控余额
#define TC_WATERDRAW 		3330 	//水控消费
#define TC_WATERDRAWRETURN 	3335 	//水控消费
#define TC_BUSDRAW 			3340 	//车载消费
#define TC_WATERNOBALARET	3350	//水控不平金额退款
#define TC_DEDUCTCARDBAL	3360	//扣卡余额
#define TC_RETURNBOARDFEE	3370	//退搭伙费
#define TC_ADDCARDBAL		3380	//补写卡余额
#define TC_CLOSED2NEWCARD 	3390	//余额转移
...
#define TC_SHOPSUBJECTADD	5020	//商户科目映射
#define TC_SHOPSUBJECTUPD   5021	//商户科目映射修改
#define TC_SHOPSUBJECTDEL   5022	//商户科目映射删除
...
#define TC_VOUCHERMAKE		7010	//凭证录入
#define TC_VOUCHERUPD		7011	//凭证修改
#define TC_VOUCHERDEL		7012	//凭证删除
#define TC_VOUCHERSIGN		7013	//凭证签字
#define TC_VOUCHERCHECK		7020	//凭证复核
#define TC_VOUCHERCHECKREV	7021	//凭证复核取消
#define TC_VOUCHERBOOK		7030	//凭证入账
#define TC_VOUCHERBOOKREV	7040	//凭证冲销

#define TC_SHOPPAYMENT   	8000   	//商户解款
#define TC_DAYEND			9000	//日终结算
#define TC_MONTHEND			9010	//期末结转
#define TC_YEAREND			9020	//年终结转
