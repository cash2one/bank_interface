...
#define SYSPARA_ACCFLAG				1		//结算标志
#define SYSPARA_SETTLEDATE 			2		//结算日期
#define SYSPARA_POSWORKMODE			3		//POS机工作模式
#define SYSPARA_RENEWCARDDAYCNT		4 		//补办卡天数
#define SYSPARA_AUTORENEWACCMAXAMT	5		//自动平帐金额最大限额
#define POS_FRONT_VERNO				6		//前置机版本号
#define SYSPARA_BANKCARDONLINEBIND	7       //银行卡绑定模式 0-本地绑定,1银行联机绑定
#define SYSPARA_BANKCARDAUTHMODE 8 //银行卡圈存验证模式，0- 本地绑定验证1- 密码验证
#define SYSPARA_QRYMAXCNT			9		//无条件查询最大条数
#define SYSPARA_SHOPBOARDFEEFLAG	10		//消费收搭伙费是否属于商户
#define SYSPARA_MAXBLACKCARDVERNO 	11		//最大黑名单版本号
#define SYSPARA_MAXCARDVERNO 		12		//最大卡名单版本号
#define SYSPARA_DISABLECARDMGR 		13		//是否启用卡片库存管理
#define SYSPARA_CARDPWDVER			14		//密码版本:1,2-老版本,3-新版本
#define SYSPARA_APPNAME				15		//应用系统名称
#define SYSPARA_BROADCASTBLKLIST	20      //是否广播黑名单
#define SYSPARA_SINGLEMAXAMT		21		//单次消费限额
#define SYSPARA_DAYMAXAMT			22      //日消费限额
#define SYSPARA_CARDCNTPERCUST		23		//每个客户可以发行正式卡张数
#define SYSPARA_SUBSIDYMODE			24		//下发补助模式
#define SYSPARA_CMCCENTERPRICECODE  25		//移动规范定义企业ID 号
#define SYSPARA_CMCCSUBAPPID		26		//移动规范定义子应用索引
#define SYSPARA_SYMAXCARDCNT		27		//索亚门禁支持最大卡片数量
#define SYSPARA_WATERMAXAMT			30		//水控消费最大金额
#define SYSPARA_LOCKDEVNO			31		//后付费锁卡时记录终端号类型
...
#define TRANSTATUS_TAC_ERR 8    //TAC 验证不符
#define TRANSTATUS_REV_PENDING  9    //待冲正

//#define TRANSTATUS_TAC_OK 2     //TAC 验证通过
...
#define STATUS_UNCONFIRMED		'0'		//发行未确认
#define STATUS_RENEW_UNCONFIRMED	'3'		//补办未确认
#define STATUS_RENEW			'4'		//待补办
#define STATUS_INSTEAD			'5'		//待换卡
#define STATUS_NORMAL			'1'
#define STATUS_DELETE			'2'
//#define STATUS_CLOSING			'9'		//销户中
