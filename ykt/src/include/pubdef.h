...
//#define CFGTYPE_CFGVER				5
#define CARD_STRUCT_VERSION				"1"
#define CARD_REGISTER_PUBLISH_CODE 		"9156000027"
#define CARD_REGISTER_SERVICE_CODE		"D156000026"
#define YKT_VERSION		"1.1"
#define SUCCESS   0
#define DB_SUCCESS 0
...
// 根节点ID
#define ROOT_deviceid	1

//CPU卡密钥定义
#define MAINKEY 	1		//主密钥
#define DPK1		11		//消费密钥1
#define DPK2		12		//消费密钥2
#define DLK1		21		//圈存密钥1
#define DLK2		22		//圈存密钥1
#define DTAC1		31		//内部密钥1
#define DTAC2		32		//内部密钥2
#define DUK			40		//PIN解锁
#define DRPK		50		//PIN重装
#define DAMK		60		//维护密钥
#define DACK1		71		//外部认证密钥1
#define DACK2		72		//外部认证密钥2
#define DACK3		73		//外部认证密钥3
#define LDACK		81		//小钱包外部认证密钥
#define LDAMK		82		//小钱包维护密钥

//系统主键内容
#define KEYTYPE_OPERID			"OPERID"					//操作员ID
#define KEYTYPE_TERMID			"TERMID"					//终端号
#define KEYTYPE_CARDACCNO		"CARDACCNO"						//账号
#define KEYTYPE_SHOPACCNO		"SHOPACCNO"						//账号
#define KEYTYPE_NETACCNO		"NETACCNO"						//账号
#define KEYTYPE_CARDNO  		"CARDNO"					//卡号
#define KEYTYPE_CUSTOMER  		"CUSTID"					//客户号
#define KEYTYPE_SHOP  			"SHOPID"					//商户号
#define KEYTYPE_SUBSYSTEM 	 	"SYSID"						//子系统注册表
#define KEYTYPE_VOUCHERID  		"VOUCHERID"					//凭证表ID
#define KEYTYPE_SUBLEDGERID		"SUBLEDGERID"					//明细账ID
#define KEYTYPE_WATERFEECFG		"WATERFEECFG"				//水控费率参数
...
#define KEYTYPE_MESLIST 		"MSGID"							//消息队列
...
#define KEYTYPE_DOOR_HOLIDAY				"t_doorholiday"			//门禁节假日
#define KEYTYPE_DOOR_DEV_HLD				"T_DOOR_DEVICE_HOLIDAY_VER"	//门禁机节假日版本							//
#define KEYTYPE_MEAL_TYPE					"T_PIF_MEAL_TYPE"	//商户餐次定义
#define KEYTYPE_DOOR_time				"T_DOOR_TIME_SECT"  //门禁时间段
#define KEYTYPE_DOOR_WEEKS				"T_DOOR_WEEKS" //门禁时间段组
#define KEYTYPE_DOOR_GROUP				"T_DOOR_GROUP" //门禁组
#define KEYTYPE_DOOR_TIME_GROUP			"T_DOOR_TIMES_GROUP" //门禁时间段组
#define KEYTYPE_PIF_SUB_UPDATE			"T_PIF_SUB_UPDATE" //子系统更新名单表
#define KEYTYPE_SUBSIDYNO				"SUBSIDYNO"	//补助批次号
#define KEYTYPE_T_ATTSERIAL				"T_ATTSERIAL"
#define KEYTYPE_DOORDTL					"DOORDTL"		//门禁流水
#define KEYTYPE_DOORDOWNLOAD			"T_DOORDOWNLOAD"		//门禁下发名单表
#define KEYTYPE_SMLDTL			        "SMLDTL" // 小钱包流水号

#define KEYTYPE_ISBP_SERIALNO			"ISBP_SERIALNO" //ISBP报盘文件


#define KEYTYPE_PLANTASK       "PLANTASK"
...
#define TXCODE_BANK_DETRANS			241011	//圈存冲正
...
#define TXCODE_REVERSE_CASH			8471061 //现金充值冲正
...
#define TXCODE_DESUBSIDY_DOWN		847140	//扣款下发
#define TXCODE_MOBILE_TRANS			847133	//手机充值
#define TXCODE_ELECT_TRANS				847134	//电控转账
#define TXCODE_MERCH_OPEN				847135	//发行商户卡
#define TXCODE_MERCH_CLOSE 			847136   //注销商户卡
//#define TXCODE_ELECT_TRANS			847136	//电控转账

// 上大账务定义
#define TXCODE_FAN_PAY_MONEY			847220	//充值解款
#define TXCODE_FAN_RUSH_PAY			847221	//冲正充值解款

//水控转账
#define TXCODE_CONSUME              847301   //大钱包转小钱包扣款
#define TXCODE_SAVING_SMALL_PACKET    847300   //小钱包充值
//#define TXCODE_REWRITE_CARD_PACKET   847303    //水控大钱包补写卡
#define TXCODE_RESET_DEVICE  847303             //设置重置设备
#define TXCODE_COLLECT_IN_ACCOUNT    847306    //采集总额入账

#define TXCODE_FAN_BALANCE			847222	//商户消费结算
#define TXCODE_FAN_RUSH_BALANCE		847223	//冲正商户消费结算

// 操作员授权卡定义
#define TXCODE_ISSUE_AUTHCARD			847226   //发行授权卡
#define TXCODE_CANCEL_AUTHCARD		847227	//回收授权卡
#define TXCODE_MODIFY_AUTHCARD		847228	//更新授权卡
#define TXCODE_LOSS_AUTHCARD			847229	//挂失授权卡
#define TXCODE_UNLOSS_AUTHCARD		847230   //解挂授权卡

#define TXCODE_RAKEOFF					847231   //佣金划拨
#define TXCODE_AGIO						847232   //佣金折扣

//海事考试报名
#define TXCODE_TURNOVER					847233	//考试报名
...
#define XML_KEY_USETYPE		 "USETYPE"		//多媒体取电使用类别

#define XML_KEY_FEE				 "FEE"			//费率
#define XML_KEY_BTTIME			 "BTTIME"	       //设备监控心跳时间间隔
#define XML_KEY_NAME			"NAME"			//姓名
#define XML_KEY_AMT			"AMT"			//金额
#define XML_KEY_DATE			"DATE"			//日期
#define XML_KEY_TIME			"TIME"			//时间
#define XML_KEY_DORM_NO		"DORM_NO"		//宿舍号
#define XML_KEY_DORM_NAME		"DORM_NAME"	//宿舍名
#define XML_KEY_CUSTID			"CUSTID"		//客户号
#define XML_KEY_ELEC			"ELEC"			//电量
...
//下传设备主参数
#define XML_KEY_DEVPHY999_NO	"DEVPHYID"		//终端设备id
...
#define XML_KEY_status		"status"		//设备状态
...
// 写卡失败标志
#define CARDWFAIL_NORMAL		'N'	//普通

// 写卡失败标志记录是或者否, 进入写卡失败表
#define CARDWFAIL_PACKET_DEAL_FLAG_Y     'Y' // 写卡钱包失败标记
...
#define POSDATA_REMAIN_MAXDAY 						60		//POS流水保存最大天数(距现在) 	60
#define POSDATA_EXPIRE_MAXDAY						40		//流水过期最大天数(距现在)		40
#define POSDATA_COLLECT_MAXDAY						30		//流水补采最大天数(距现在)   	30
#define RECENTDTL_MAXDAY							31		//最近流水表最大日期			31
...
#define CARDBITMAPTYPE_INIT   '0'	 		//重置
#define CARDBITMAPTYPE_REV   	'/'	 		//消费冲正
#define CARDBITMAPTYPE_POS_ONLINE   '-'	 	//POS联机消费
#define CARDBITMAPTYPE_POS_OFFLINE  '|'		//POS脱机消费
#define CARDBITMAPTYPE_SYS_ONLINE  	'='		//非POS机消费，系统消费
