...
int DB_t_card_read_by_custid_and_status_and_cardtype(int v_custid,const char *v_status,int v_cardtype,T_t_card *pt_card);
int DB_t_card_read_by_custid_and_status(int v_custid,const char *v_status,T_t_card *pt_card);
int DB_t_card_read_by_showcardno_and_status(const char *v_showcardno,const char *v_status,T_t_card *pt_card);
int DB_t_card_read_by_cardphyid_and_status(const char *v_cardphyid,const char *v_status,T_t_card *pt_card);
